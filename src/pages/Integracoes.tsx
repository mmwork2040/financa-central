...
const PLATAFORMAS: Plataforma[] = [
  ...
  {
    id: "banco_do_brasil", name: "Banco do Brasil", description: "API do Banco do Brasil para cobranças, Pix e extratos",
    icon: Landmark, color: "bg-yellow-100 text-yellow-700",
    site: "https://developers.bb.com.br/", doc: "https://developers.bb.com.br/referencia",
    events: ["cobranca_paga", "pix_recebido", "boleto_pago"],
    steps: [
      "Acesse developers.bb.com.br e crie uma conta de desenvolvedor",
      "Crie um novo aplicativo e selecione as APIs desejadas (Cobranças, Pix, Extratos)",
      "Gere as credenciais OAuth2 (Client ID e Client Secret)",
      "Copie o Client ID e o Client Secret gerados",
      "Cole o Client ID como API Key e o Client Secret como Secret abaixo",
    ],
    needsSecret: true, usesWebhook: true, keyValidation: { hint: "Client ID do aplicativo BB" },
    categoria: "bancos",
  },
  {
    id: "bradesco", name: "Bradesco", description: "API Bradesco para cobranças, Pix e consultas",
    icon: Landmark, color: "bg-red-100 text-red-600",
    site: "https://developers.bradesco.com.br/", doc: "https://developers.bradesco.com.br/documentacao",
    events: ["cobranca_paga", "pix_recebido", "boleto_registrado"],
    steps: [
      "Acesse developers.bradesco.com.br e cadastre-se como desenvolvedor",
      "Crie um novo aplicativo no portal de APIs",
      "Selecione as APIs desejadas (Registro de Boletos, Pix, Transferências)",
      "Gere as credenciais de acesso (Client ID e Client Secret)",
      "Cole o Client ID como API Key e o Client Secret como Secret abaixo",
    ],
    needsSecret: true, usesWebhook: true, keyValidation: { hint: "Client ID do aplicativo Bradesco" },
    categoria: "bancos",
  },
  {
    id: "santander", name: "Santander", description: "API Santander para cobranças, Pix e Open Finance",
    icon: Landmark, color: "bg-red-100 text-red-700",
    site: "https://developer.santander.com.br/", doc: "https://developer.santander.com.br/api",
    events: ["cobranca_paga", "pix_recebido", "transferencia_realizada"],
    steps: [
      "Acesse developer.santander.com.br e crie uma conta de desenvolvedor",
      "Crie um novo aplicativo e selecione os produtos desejados",
      "Gere as credenciais OAuth2 (Client ID e Client Secret)",
      "Copie o Client ID e o Client Secret gerados",
      "Cole o Client ID como API Key e o Client Secret como Secret abaixo",
    ],
    needsSecret: true, usesWebhook: true, keyValidation: { hint: "Client ID do aplicativo Santander" },
    categoria: "bancos",
  },
  {
    id: "itau", name: "Itaú", description: "API Itaú para cobranças, Pix e Open Finance",
    icon: Landmark, color: "bg-orange-100 text-orange-700",
    site: "https://developer.itau.com.br/", doc: "https://developer.itau.com.br/api-catalog",
    events: ["cobranca_paga", "pix_recebido", "boleto_pago"],
    steps: [
      "Acesse developer.itau.com.br e crie uma conta de desenvolvedor",
      "Navegue até o catálogo de APIs e selecione os produtos desejados",
      "Crie um novo aplicativo e gere as credenciais OAuth2",
      "Copie o Client ID e o Client Secret gerados",
      "Cole o Client ID como API Key e o Client Secret como Secret abaixo",
    ],
    needsSecret: true, usesWebhook: true, keyValidation: { hint: "Client ID do aplicativo Itaú" },
    categoria: "bancos",
  },
];
