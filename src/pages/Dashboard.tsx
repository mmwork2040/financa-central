      ...
      {!isSuperAdmin && assinaturaStatus === 'ativo' && (
        <div className="flex items-center gap-2 rounded-lg bg-primary/5 border border-primary/20 px-3 py-2">
          ...
          <p className="text-xs text-muted-foreground">
            Plano <span className="font-semibold text-foreground">ativo</span>
          </p>
          <Button variant="ghost" size="sm" className="ml-auto text-xs text-primary p-0 h-auto" onClick={() => navigate("/ver-planos")}>
            Ver planos
          </Button>
        </div>
      )}
